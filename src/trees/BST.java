...
/**
 * The {@code trees.BST} class represents an ordered symbol table of generic
 * key-value pairs.
...
public class BST<Key extends Comparable<Key>, Value> {
    private Node root;             // root of trees.BST
    ...
    // return number of key-value pairs in trees.BST rooted at x
    ...
    /**
     * Returns the height of the trees.BST (for debugging).
     *
     * @return the height of the trees.BST (a 1-node tree has height 0)
     */
    public int height() {
        return height(root);
    }
    ...
    /**
     * Returns the keys in the trees.BST in level order (for debugging).
     *
     * @return the keys in the trees.BST in level order traversal
     */
    ...
    /*************************************************************************
     *  Check integrity of trees.BST data structure.
     ***************************************************************************/
    ...
    // is the tree rooted at x a trees.BST with all keys strictly between min and max
    ...
    /**
     * Unit tests the {@code trees.BST} data type.
     *
